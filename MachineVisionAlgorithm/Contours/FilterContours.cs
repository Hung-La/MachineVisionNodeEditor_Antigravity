...
{
    public static class FilterContours
    {
        public static Mat ApplyFilterContours(
            Mat src,
            double areaMin,
            double areaMax,
            Scalar color,
            ...
            out Point[][] contours)
        {
            ...
            Cv2.FindContours(binaryCopy, out contours, out _, RetrievalModes.External, ContourApproximationModes.ApproxSimple);
